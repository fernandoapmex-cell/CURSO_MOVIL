  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Align(alignment: Alignment.topRight, child: IconButton(onPressed: (){}, icon: Icon(Icons.more_vert_outlined))),
...
class _CardType2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      shape: RoundedRectangleBorder(side: BorderSide(color: colors.outline), borderRadius: BorderRadius.all(Radius.circular(20))),
      elevation: elevation,
      child: Padding(
        padding: EdgeInsets.fromLTRB(10, 5, 10, 10),
        child: Column(
